...
const BidItem = ({ bid, index, product_id, setBids, layout }) => {
  ...
  return (
    <motion.div
      ...
      className="border border-pink-300/10 bg-white/5 rounded-2xl p-4 shadow-md flex flex-col gap-4"
    >
      ...
      <div className="flex justify-between items-center border-t border-purple-500/10 pt-2">
        <p className="text-xl font-semibold text-pink-400">৳{bid.bid_price}</p>
        <span
